resource "aws_api_gateway_rest_api" "${var.project}_api" {
...
resource "aws_api_gateway_resource" "dynamo_resources" {
  ...
  rest_api_id = aws_api_gateway_rest_api.${var.project}_api.id
  parent_id   = aws_api_gateway_rest_api.${var.project}_api.root_resource_id
...
resource "aws_api_gateway_integration" "dynamo_integrations" {
  ...
  credentials             = aws_iam_role.${var.project}_dynamo_role.arn
...
resource "aws_api_gateway_deployment" "${var.project}_deployment" {
...
resource "aws_iam_role" "${var.project}_dynamo_role" {
...
resource "aws_iam_role_policy_attachment" "dynamo_policy_attachment" {
  role       = aws_iam_role.${var.project}_dynamo_role.name
